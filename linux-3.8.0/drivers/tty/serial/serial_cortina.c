...
static struct uart_driver cortina_uart_driver = {
	...
	.minor = 64,
		...
		#else
			.nr = 3,
		#endif	/* CONFIG_CORTINA_UART3 */
	#else	/* CONFIG_CORTINA_UART3 */
		#ifdef	CONFIG_CORTINA_UART3
			.nr = 3,
		#else
			.nr = 2,
		#endif	/* CONFIG_CORTINA_UART3 */
	#endif	/* CONFIG_CORTINA_UART2 */
#else	/* CONFIG_CIRTINA_UART1 */
	#ifdef	CONFIG_CORTINA_UART2
		#ifdef	CONFIG_CORTINA_UART3
			.nr = 3,
		#else
