...
#else	/* CONFIG_CORTINA_FPGA */
#ifdef	CONFIG_CS75XX_PHY_ADDR_GMAC0 
#define GE_PORT0_PHY_ADDR	CONFIG_CS75XX_PHY_ADDR_GMAC0 /* GMAC-0 */
#else	/* CONFIG_CS75XX_PHY_ADDR_GMAC0 */
#define GE_PORT0_PHY_ADDR	0x1F
#endif	/* CONFIG_CS75XX_PHY_ADDR_GMAC0 */

#ifdef	CONFIG_CS75XX_PHY_ADDR_GMAC1
#define GE_PORT1_PHY_ADDR	CONFIG_CS75XX_PHY_ADDR_GMAC1 /* GMAC-1 */
#else	/* CONFIG_CS75XX_PHY_ADDR_GMAC1 */
#define GE_PORT1_PHY_ADDR	0x1F
#endif	/* CONFIG_CS75XX_PHY_ADDR_GMAC1 */

#ifdef	CONFIG_CS75XX_PHY_ADDR_GMAC2 
#define GE_PORT2_PHY_ADDR	CONFIG_CS75XX_PHY_ADDR_GMAC2 /* GMAC-2 */
#else	/* CONFIG_CS75XX_PHY_ADDR_GMAC2 */
#define GE_PORT2_PHY_ADDR	0x1F
#endif	/* CONFIG_CS75XX_PHY_ADDR_GMAC2 */
