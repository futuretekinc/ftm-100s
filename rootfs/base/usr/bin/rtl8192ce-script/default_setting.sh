...
CONFIG_DIR=/var/rtl8192c/$1
##rm -Rf /var/rtl8192c
##mkdir -p /var/rtl8192c
mkdir -p /var/rtl8192c/$1
...
echo "Cortina_AP_Test" >  $CONFIG_DIR/ssid
...
echo "192.168.1.1" > /var/rtl8192c/ip_addr
echo "255.255.255.0" > /var/rtl8192c/net_mask
echo "RTL8192C" > /var/rtl8192c/device_name
echo "0" > /var/rtl8192c/repeater_enabled
echo "" > /var/rtl8192c/repeater_ssid
