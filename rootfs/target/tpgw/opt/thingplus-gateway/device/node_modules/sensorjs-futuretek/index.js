...
var ACTUATOR_DRIVER_NAME = 'futureActuator', 
  ACTUATOR_DRIVER_MODELS = ['futureDo', 'futureTempCtrl'],
  SENSOR_DRIVER_NAME = 'futureSensor',
  SENSOR_DRIVER_MODELS =  ['futureDi', 'futureTemp', 'futureHumi', 
    'futureGas', 'futurePower', 'futureDust', 'futureCount', 
    'futureVoltage', 'futureCurrent', 'futurePressure'],
  NETWORK_DRIVER_NAME = 'future';
function initNetworks() {
  var net, rtn;

  try {
    net = require(['./network',NETWORK_DRIVER_NAME].join('/'));
  } catch (e) {
