 ...
 * @param driverOrModel {String} driver ot model [Optional]
 * @param cb {Function} call back
 */
function retrieveDeviceInfo(targetIp, oids, driverOrModel, cb) {
  var sensorInfos = [],
...
function startScanning(self, cb) {
  ...
  try {
    bcastClient.bind(cfg.SNMP_TRAP_PORT, function() {
      ...
      _.each(parsedMsg.pdu.varbinds, function (vb) {
        ...
        case cfg.DISCOVERY_MSG_OID:
          try {
            ...
            retrieveDeviceInfo(targetIp, _.map(discoveryMsg.oids, function (v){
