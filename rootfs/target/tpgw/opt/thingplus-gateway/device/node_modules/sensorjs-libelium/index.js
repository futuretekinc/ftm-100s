...
var ACTUATOR_DRIVER_NAME, //=  'libeliumActuator', // none for now
  ACTUATOR_DRIVER_MODELS = [], //= ['libeliumFan']
  SENSOR_DRIVER_NAME = 'libeliumSensor', 
  SENSOR_DRIVER_MODELS = ['libeliumTemp', 'libeliumHumi', 'libeliumLight',
    'libeliumNoise', 'libeliumCo2', 'libeliumCo', 'libeliumVoc', 'libeliumCount',
    'libeliumWeight', 'libeliumColor', 'libeliumVibration', 'libeliumSpeed', 'libeliumOnoff'
  ],
  NETWORK_DRIVER_NAME = 'libelium';
