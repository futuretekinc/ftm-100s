...
#else /* CONFIG_CS75XX */
    spinlock_t       an_active_tx_lock;     /* pending tx thread */
#endif /* CONFIG_CS75XX */
#ifdef  ATH_SUPPORT_TxBF
...
#define ATH_NODE_ACTIVE_TX_LOCK_INIT(_an)           spin_lock_init(&(_an)->an_active_tx_lock)
#define ATH_NODE_ACTIVE_TX_LOCK_DESTROY(_an)
#define ATH_NODE_ACTIVE_TX_LOCK(_an)                spin_lock_bh(&(_an)->an_active_tx_lock)
#define ATH_NODE_ACTIVE_TX_UNLOCK(_an)              spin_unlock_bh(&(_an)->an_active_tx_lock)
...
extern bool CS_AR9580_WFO_ath_hal_reset(struct ath_hal *ah, HAL_OPMODE opmode, HAL_CHANNEL *chan,
...
#define ath_hal_reset(_ah, _opmode, _chan, _macmode, _txchainmask, _rxchainmask, _extprotspacing, _outdoor, _pstatus, _is_scan) \
    CS_AR9580_WFO_ath_hal_reset((_ah), (_opmode), (_chan), (_macmode), (_txchainmask), (_rxchainmask), (_extprotspacing), (_outdoor), (_pstatus), (_is_scan))
#else
#define ath_hal_reset(_ah, _opmode, _chan, _macmode, _txchainmask, _rxchainmask, _extprotspacing, _outdoor, _pstatus, _is_scan) \
...
extern bool CS_AR9580_WFO_ath_hal_puttxbuf(struct ath_hal *ah, u_int q, u_int32_t txdp);
#define ath_hal_puttxbuf(_ah, _q, _bufaddr) \
    CS_AR9580_WFO_ath_hal_puttxbuf((_ah), (_q), (_bufaddr))
#else
#define ath_hal_puttxbuf(_ah, _q, _bufaddr) \
