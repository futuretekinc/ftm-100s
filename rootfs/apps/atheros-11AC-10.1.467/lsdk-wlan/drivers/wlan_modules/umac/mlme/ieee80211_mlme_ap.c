...
extern bool CS_AR9580_WFO_TX_mac_entry_add(struct ath_softc_net80211 *scn, struct ieee80211_node *ni);
extern bool CS_AR9580_WFO_mac_entry_timer_add(struct ath_softc_net80211 *scn, struct ieee80211_node *ni);
extern bool CS_AR9580_WFO_setup_power_saving(struct ath_softc_net80211 *scn, struct ieee80211_node *ni);
#endif
...
#endif                
#ifdef CONFIG_CS75XX_WFO_AR9580
        CS_AR9580_WFO_TX_mac_entry_add(vap->iv_ic, ni);
		if (cs_wfo_rate_adjust)
			CS_AR9580_WFO_mac_entry_timer_add(vap->iv_ic, ni);
#endif
...
#ifdef CONFIG_CS75XX_WFO_AR9580
            CS_AR9580_WFO_setup_power_saving(vap->iv_ic, ni);
#endif            
        } else {
