...
#ifdef CONFIG_CS75XX_WFO_AR9580
     u_int8_t   cs_wfo_status;
    u_int32_t   cs_wfo_ds_ctl13;  /* DMA control 13 */
    u_int32_t   cs_wfo_ds_ctl14;  /* DMA control 14 */
    u_int32_t   cs_wfo_ds_ctl15;  /* DMA control 15 */
    u_int32_t   cs_wfo_ds_ctl16;  /* DMA control 16 */
    u_int32_t   cs_wfo_ds_ctl17;  /* DMA control 17 */
    u_int32_t   cs_wfo_ds_ctl18;  /* DMA control 18 */
    u_int32_t   cs_wfo_ds_ctl19;  /* DMA control 19 */
    u_int32_t   cs_wfo_ds_ctl20;  /* DMA control 20 */
    u_int32_t   cs_wfo_ds_ctl21;  /* DMA control 21 */
       u_int32_t   cs_wfo_ds_ctl22;  /* DMA control 22 */
       os_timer_t      wfo_rateadapttimer;
       u_int32_t       wfo_rateadapttimer_period;

       struct cs_ar9580_wfo_ieee80211_key pe_key;
       struct ath_rc_series ni_rcs[4];
       u_int32_t ni_txctl_flags;
       u_int32_t ni_shortPreamble;
       u_int32_t ni_frametype;
#endif
