...
Currently available applets include:
	...
	bash, blkid, blockdev, bunzip2, bzcat, cat, chgrp, chmod, chown,
	chroot, clear, cmp, cp, crond, crontab, cut, date, dd, delgroup,
	deluser, depmod, df, dhcprelay, diff, dirname, dmesg, dnsdomainname,
	du, dumpleases, echo, egrep, env, expr, false, fdisk, fgrep, find,
	free, fstrim, ftpd, ftpget, ftpput, getopt, getty, grep, groups,
	gunzip, gzip, halt, hd, hdparm, head, hexdump, hostid, hostname,
	httpd, hwclock, id, ifconfig, ifdown, ifup, inetd, init, insmod,
	iostat, ip, ipaddr, iplink, iproute, iprule, iptunnel, kill,
	killall, killall5, klogd, less, ln, lock, logger, login, logread,
	ls, lsmod, lsof, lspci, lsusb, md5sum, mesg, mkdir, mkdosfs, mke2fs,
	mkfifo, mkfs.ext2, mkfs.minix, mkfs.reiser, mkfs.vfat, mknod,
	mkswap, mktemp, modprobe, more, mount, mpstat, mv, nanddump,
	nandwrite, nbd-client, nc, netstat, nice, nohup, nslookup, passwd,
	pgrep, pidof, ping, ping6, pivot_root, pkill, pmap, poweroff,
	powertop, printf, ps, pstree, pwd, pwdx, rdate, readlink, reboot,
	renice, reset, resize, rm, rmdir, rmmod, route, run-parts, sed, seq,
	setserial, sh, sha3sum, sleep, sort, start-stop-daemon, strings,
	stty, svlogd, swapoff, swapon, switch_root, sync, sysctl, syslogd,
	tail, tar, taskset, tcpsvd, tee, telnet, telnetd, test, tftp, time,
	top, touch, tr, traceroute, true, tty, ubimkvol, ubirmvol, ubirsvol,
	ubiupdatevol, udhcpc, udhcpd, umount, uname, uniq, uptime, usleep,
	vconfig, vi, watchdog, wc, wget, which, whois, xargs, yes, zcat
